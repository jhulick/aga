...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        .and()
            ...
            .antMatchers("/health/**").permitAll() //.hasAuthority(AuthoritiesConstants.ADMIN)
            .antMatchers("/trace/**").permitAll() //.hasAuthority(AuthoritiesConstants.ADMIN)
            .antMatchers("/dump/**").permitAll() //.hasAuthority(AuthoritiesConstants.ADMIN)
            .antMatchers("/shutdown/**").hasAuthority(AuthoritiesConstants.ADMIN)
            .antMatchers("/beans/**").hasAuthority(AuthoritiesConstants.ADMIN)
            .antMatchers("/configprops/**").hasAuthority(AuthoritiesConstants.ADMIN)
            .antMatchers("/info/**").permitAll() //.hasAuthority(AuthoritiesConstants.ADMIN)
            .antMatchers("/autoconfig/**").hasAuthority(AuthoritiesConstants.ADMIN)
            .antMatchers("/env/**").permitAll() //.hasAuthority(AuthoritiesConstants.ADMIN)
            .antMatchers("/trace/**").permitAll() //.hasAuthority(AuthoritiesConstants.ADMIN)
