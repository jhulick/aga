 ...
 * </p>
 */
@ConfigurationProperties(prefix = "max", ignoreUnknownFields = false)
public class MaxProperties {
    ...
    public static class Mail {
        ...
        private String from = "maxgateway@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "maxgateway API";

        private String description = "maxgateway API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "maxgateway";
