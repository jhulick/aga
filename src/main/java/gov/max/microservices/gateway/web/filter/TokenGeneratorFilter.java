...
import gov.max.microservices.gateway.security.AppUserDetails;
...
import gov.max.microservices.gateway.security.jwt.UserAuthentication;
...
public class TokenGeneratorFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        // If the user has been authenticated with CAS, add the JWT token
