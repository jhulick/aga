...
public class CustomPersistentRememberMeServices extends
    ...
    @Inject
    private gov.max.microservices.gateway.repository.PersistentTokenRepository persistentTokenRepository;
    ...
    public CustomPersistentRememberMeServices(Environment env, org.springframework.security.core.userdetails
        ...
        super(env.getProperty("max.security.rememberme.key"), userDetailsService);
