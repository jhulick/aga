...
import gov.max.microservices.gateway.config.audit.AuditEventConverter;
import gov.max.microservices.gateway.domain.PersistentAuditEvent;
import gov.max.microservices.gateway.repository.PersistenceAuditEventRepository;
import gov.max.microservices.gateway.service.AuditEventService;
