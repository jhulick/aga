...
import gov.max.microservices.gateway.repository.AuthorityRepository;
import gov.max.microservices.gateway.repository.UserRepository;
import gov.max.microservices.gateway.security.AuthoritiesConstants;
import gov.max.microservices.gateway.service.UserService;
import gov.max.microservices.gateway.web.rest.dto.UserDTO;
...
public class AccountResourceIntTest {
    ...
    public void testGetExistingAccount() throws Exception {
        ...
        user.setEmail("john.doe@max.gov");
        ...
        restUserMockMvc.perform(get("/api/account")
                ...
                .andExpect(jsonPath("$.email").value("john.doe@max.gov"))
